        ...
        google.script.run
            .withSuccessHandler((response) => {
                if (response && response.success && response.data) {
                    ...
                    if (response.data.users && response.data.users.length > 0) state.users = response.data.users;
                    if (response.data.bookings && response.data.bookings.length > 0) state.bookings = response.data.bookings;
